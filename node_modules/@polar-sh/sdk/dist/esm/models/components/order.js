...
/** @internal */
export const OrderCustomFieldData$inboundSchema = smartUnion([
    z.string(),
    z.int(),
    z.boolean(),
...
/** @internal */
export const OrderCustomFieldData$outboundSchema = smartUnion([
    z.string(),
    z.int(),
    z.boolean(),
...
/** @internal */
export const OrderDiscount$inboundSchema = smartUnion([
...
/** @internal */
export const OrderDiscount$outboundSchema = smartUnion([

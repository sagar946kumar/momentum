...
/** @internal */
export declare const CustomFieldData$inboundSchema: z.ZodMiniType<CustomFieldData, unknown>;
/** @internal */
export type CustomFieldData$Outbound = string | number | boolean | string;
/** @internal */
export declare const CustomFieldData$outboundSchema: z.ZodMiniType<CustomFieldData$Outbound, CustomFieldData>;
...
/** @internal */
export declare const SubscriptionDiscount$inboundSchema: z.ZodMiniType<SubscriptionDiscount, unknown>;
/** @internal */
...
/** @internal */
export declare const SubscriptionDiscount$outboundSchema: z.ZodMiniType<SubscriptionDiscount$Outbound, SubscriptionDiscount>;
...
/** @internal */
export declare const SubscriptionPrices$inboundSchema: z.ZodMiniType<SubscriptionPrices, unknown>;
/** @internal */
export type SubscriptionPrices$Outbound = LegacyRecurringProductPrice$Outbound | ProductPrice$Outbound;
/** @internal */
export declare const SubscriptionPrices$outboundSchema: z.ZodMiniType<SubscriptionPrices$Outbound, SubscriptionPrices>;
...
/** @internal */
export declare const Subscription$outboundSchema: z.ZodMiniType<Subscription$Outbound, Subscription>;

...
/** @internal */
export const CustomerStateSubscriptionCustomFieldData$inboundSchema = smartUnion([
    z.string(),
    z.int(),
    z.boolean(),
...
/** @internal */
export const CustomerStateSubscriptionCustomFieldData$outboundSchema = smartUnion([
    z.string(),
    z.int(),
    z.boolean(),

...
import { ListResourceSubscription } from "../components/listresourcesubscription.js";
...
/** @internal */
export declare const OrganizationIDFilter$outboundSchema: z.ZodMiniType<OrganizationIDFilter$Outbound, OrganizationIDFilter>;
...
/** @internal */
export declare const ProductIDFilter$outboundSchema: z.ZodMiniType<ProductIDFilter$Outbound, ProductIDFilter>;
...
/** @internal */
export declare const CustomerIDFilter$outboundSchema: z.ZodMiniType<CustomerIDFilter$Outbound, CustomerIDFilter>;
...
/** @internal */
export declare const ExternalCustomerIDFilter$outboundSchema: z.ZodMiniType<ExternalCustomerIDFilter$Outbound, ExternalCustomerIDFilter>;
...
/** @internal */
export declare const DiscountIDFilter$outboundSchema: z.ZodMiniType<DiscountIDFilter$Outbound, DiscountIDFilter>;
...
/** @internal */
export declare const SubscriptionsListRequest$outboundSchema: z.ZodMiniType<SubscriptionsListRequest$Outbound, SubscriptionsListRequest>;
export declare function subscriptionsListRequestToJSON(subscriptionsListRequest: SubscriptionsListRequest): string;
/** @internal */
export declare const SubscriptionsListResponse$inboundSchema: z.ZodMiniType<SubscriptionsListResponse, unknown>;

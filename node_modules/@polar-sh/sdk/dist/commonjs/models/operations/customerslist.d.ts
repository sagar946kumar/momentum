...
import { ListResourceCustomerWithMembers } from "../components/listresourcecustomerwithmembers.js";
...
/** @internal */
export declare const CustomersListQueryParamOrganizationIDFilter$outboundSchema: z.ZodMiniType<CustomersListQueryParamOrganizationIDFilter$Outbound, CustomersListQueryParamOrganizationIDFilter>;
...
/** @internal */
export declare const CustomersListRequest$outboundSchema: z.ZodMiniType<CustomersListRequest$Outbound, CustomersListRequest>;
export declare function customersListRequestToJSON(customersListRequest: CustomersListRequest): string;
/** @internal */
export declare const CustomersListResponse$inboundSchema: z.ZodMiniType<CustomersListResponse, unknown>;

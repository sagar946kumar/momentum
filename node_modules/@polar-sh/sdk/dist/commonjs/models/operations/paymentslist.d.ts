 ...
 */
export type PaymentsListQueryParamStatusFilter = PaymentStatus | Array<PaymentStatus>;
/**
...
/** @internal */
export declare const PaymentsListQueryParamOrganizationIDFilter$outboundSchema: z.ZodMiniType<PaymentsListQueryParamOrganizationIDFilter$Outbound, PaymentsListQueryParamOrganizationIDFilter>;
...
/** @internal */
export declare const PaymentsListQueryParamCheckoutIDFilter$outboundSchema: z.ZodMiniType<PaymentsListQueryParamCheckoutIDFilter$Outbound, PaymentsListQueryParamCheckoutIDFilter>;
...
/** @internal */
export declare const PaymentsListQueryParamOrderIDFilter$outboundSchema: z.ZodMiniType<PaymentsListQueryParamOrderIDFilter$Outbound, PaymentsListQueryParamOrderIDFilter>;
...
/** @internal */
export type PaymentsListQueryParamStatusFilter$Outbound = string | Array<string>;
/** @internal */
export declare const PaymentsListQueryParamStatusFilter$outboundSchema: z.ZodMiniType<PaymentsListQueryParamStatusFilter$Outbound, PaymentsListQueryParamStatusFilter>;
export declare function paymentsListQueryParamStatusFilterToJSON(paymentsListQueryParamStatusFilter: PaymentsListQueryParamStatusFilter): string;
/** @internal */
export type MethodFilter$Outbound = string | Array<string>;
/** @internal */
export declare const MethodFilter$outboundSchema: z.ZodMiniType<MethodFilter$Outbound, MethodFilter>;
...
/** @internal */
export declare const CustomerEmailFilter$outboundSchema: z.ZodMiniType<CustomerEmailFilter$Outbound, CustomerEmailFilter>;
...
/** @internal */
export declare const PaymentsListRequest$outboundSchema: z.ZodMiniType<PaymentsListRequest$Outbound, PaymentsListRequest>;
export declare function paymentsListRequestToJSON(paymentsListRequest: PaymentsListRequest): string;
/** @internal */
export declare const PaymentsListResponse$inboundSchema: z.ZodMiniType<PaymentsListResponse, unknown>;

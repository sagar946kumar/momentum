...
/** @internal */
export declare const OrderCustomFieldData$inboundSchema: z.ZodMiniType<OrderCustomFieldData, unknown>;
/** @internal */
export type OrderCustomFieldData$Outbound = string | number | boolean | string;
/** @internal */
export declare const OrderCustomFieldData$outboundSchema: z.ZodMiniType<OrderCustomFieldData$Outbound, OrderCustomFieldData>;
...
/** @internal */
export declare const OrderDiscount$inboundSchema: z.ZodMiniType<OrderDiscount, unknown>;
/** @internal */
...
/** @internal */
export declare const OrderDiscount$outboundSchema: z.ZodMiniType<OrderDiscount$Outbound, OrderDiscount>;
...
/** @internal */
export declare const Order$inboundSchema: z.ZodMiniType<Order, unknown>;
/** @internal */
...
/** @internal */
export declare const Order$outboundSchema: z.ZodMiniType<Order$Outbound, Order>;
